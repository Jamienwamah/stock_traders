# Generated by Django 4.0.10 on 2023-10-28 00:11
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total_profits', models.DecimalField(decimal_places=2, max_digits=10)),
                ('user', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='MyUserModel',
            fields=[
                ('_id', models.CharField(default=1, editable=False, max_length=24, primary_key=True, serialize=False)),
